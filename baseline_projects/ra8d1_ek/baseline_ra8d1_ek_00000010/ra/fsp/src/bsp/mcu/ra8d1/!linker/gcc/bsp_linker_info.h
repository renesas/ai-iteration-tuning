...
#define BSP_PARTITION_RAM_CPU0_S_SIZE (0xE0000)
#define BSP_PARTITION_RAM_CPU0_C_START (0x220E0000)
#define BSP_PARTITION_RAM_CPU0_C_SIZE (0x000)
...
#define BSP_PARTITION_SDRAM_CPU0_N_START (0x6C000000)
#define BSP_PARTITION_SDRAM_CPU0_N_SIZE (0x000000)
#define BSP_PARTITION_OSPI0_CS0_CPU0_S_START (0x80000000)
#define BSP_PARTITION_OSPI0_CS0_CPU0_S_SIZE (0x4000000)
#define BSP_PARTITION_OSPI0_CS0_CPU0_N_START (0x84000000)
#define BSP_PARTITION_OSPI0_CS0_CPU0_N_SIZE (0x000000)
#define BSP_PARTITION_OSPI0_CS1_CPU0_S_START (0x90000000)
#define BSP_PARTITION_OSPI0_CS1_CPU0_S_SIZE (0x4000000)
#define BSP_PARTITION_OSPI0_CS1_CPU0_N_START (0x94000000)
#define BSP_PARTITION_OSPI0_CS1_CPU0_N_SIZE (0x000000)
...
#define BSP_PARTITION_RAM_CPU0_N_SIZE (0x00000)
...
#define BSP_PARTITION_ITCM_CPU0_N_SIZE (0x0000)
#define BSP_PARTITION_DTCM_CPU0_N_START (0x30010000)
#define BSP_PARTITION_DTCM_CPU0_N_SIZE (0x0000)
