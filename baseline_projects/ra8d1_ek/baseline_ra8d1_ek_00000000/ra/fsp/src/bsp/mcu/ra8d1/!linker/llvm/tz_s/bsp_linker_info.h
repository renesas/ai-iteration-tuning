...
#define BSP_PARTITION_RAM_CPU0_S_SIZE (0x6FC00)
#define BSP_PARTITION_RAM_CPU0_C_START (0x2206FC00)
#define BSP_PARTITION_RAM_CPU0_C_SIZE (0x400)
#define BSP_PARTITION_FLASH_CPU0_S_START (0x02000000)
#define BSP_PARTITION_FLASH_CPU0_S_SIZE (0xFF800)
#define BSP_PARTITION_FLASH_CPU0_C_START (0x020FF800)
#define BSP_PARTITION_FLASH_CPU0_C_SIZE (0x800)
#define BSP_PARTITION_DATA_FLASH_CPU0_S_START (0x27000000)
#define BSP_PARTITION_DATA_FLASH_CPU0_S_SIZE (0x1800)
#define BSP_PARTITION_SDRAM_CPU0_S_START (0x68000000)
#define BSP_PARTITION_SDRAM_CPU0_S_SIZE (0x2000000)
#define BSP_PARTITION_SDRAM_CPU0_N_START (0x6A000000)
#define BSP_PARTITION_SDRAM_CPU0_N_SIZE (0x2000000)
#define BSP_PARTITION_OSPI0_CS0_CPU0_S_START (0x80000000)
#define BSP_PARTITION_OSPI0_CS0_CPU0_S_SIZE (0x2000000)
#define BSP_PARTITION_OSPI0_CS0_CPU0_N_START (0x82000000)
#define BSP_PARTITION_OSPI0_CS0_CPU0_N_SIZE (0x2000000)
#define BSP_PARTITION_OSPI0_CS1_CPU0_S_START (0x90000000)
#define BSP_PARTITION_OSPI0_CS1_CPU0_S_SIZE (0x2000000)
#define BSP_PARTITION_OSPI0_CS1_CPU0_N_START (0x92000000)
#define BSP_PARTITION_OSPI0_CS1_CPU0_N_SIZE (0x2000000)
#define BSP_PARTITION_ITCM_CPU0_S_START (0x00000000)
#define BSP_PARTITION_ITCM_CPU0_S_SIZE (0x8000)
#define BSP_PARTITION_DTCM_CPU0_S_START (0x20000000)
#define BSP_PARTITION_DTCM_CPU0_S_SIZE (0x8000)
#define BSP_PARTITION_RAM_CPU0_N_START (0x32070000)
#define BSP_PARTITION_RAM_CPU0_N_SIZE (0x70000)
#define BSP_PARTITION_FLASH_CPU0_N_START (0x12100000)
#define BSP_PARTITION_FLASH_CPU0_N_SIZE (0xF8000)
#define BSP_PARTITION_DATA_FLASH_CPU0_N_START (0x37001800)
#define BSP_PARTITION_DATA_FLASH_CPU0_N_SIZE (0x1800)
#define BSP_PARTITION_ITCM_CPU0_N_START (0x10008000)
#define BSP_PARTITION_ITCM_CPU0_N_SIZE (0x8000)
#define BSP_PARTITION_DTCM_CPU0_N_START (0x30008000)
#define BSP_PARTITION_DTCM_CPU0_N_SIZE (0x8000)
...
extern uint32_t const *const gp_ddsc_ITCM_END;
extern uint32_t const *const gp_ddsc_DTCM_START;
extern uint32_t const *const gp_ddsc_DTCM_END;
...
extern const uint32_t __ddsc_ITCM_START;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_ITCM_START = &__ddsc_ITCM_START;
extern const uint32_t __ddsc_ITCM_END;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_ITCM_END = &__ddsc_ITCM_END;
extern const uint32_t __ddsc_DTCM_START;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_DTCM_START = &__ddsc_DTCM_START;
extern const uint32_t __ddsc_DTCM_END;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_DTCM_END = &__ddsc_DTCM_END;
