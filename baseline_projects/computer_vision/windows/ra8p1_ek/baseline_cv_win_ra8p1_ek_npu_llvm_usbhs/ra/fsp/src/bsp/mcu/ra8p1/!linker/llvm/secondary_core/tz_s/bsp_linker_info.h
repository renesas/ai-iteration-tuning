...
extern uint32_t const *const gp_ddsc_CTCM_START;
extern uint32_t const *const gp_ddsc_CTCM_END;
extern uint32_t const *const gp_ddsc_STCM_START;
extern uint32_t const *const gp_ddsc_STCM_END;
...
extern const uint32_t __ddsc_CTCM_START;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_CTCM_START = &__ddsc_CTCM_START;
extern const uint32_t __ddsc_CTCM_END;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_CTCM_END = &__ddsc_CTCM_END;
extern const uint32_t __ddsc_STCM_START;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_STCM_START = &__ddsc_STCM_START;
extern const uint32_t __ddsc_STCM_END;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_STCM_END = &__ddsc_STCM_END;
...
extern const uint32_t __sau_ddsc_FLASH_NSC;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_FLASH_NSC = &__sau_ddsc_FLASH_NSC;
...
extern const uint32_t __sau_ddsc_RAM_NSC;
BSP_DONT_REMOVE uint32_t const * const gp_ddsc_RAM_NSC = &__sau_ddsc_RAM_NSC;
